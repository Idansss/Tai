...
| Design configurations/rendering      | TMS-B3-001–003 | `apps/api/src/designs` and design migration; B3-002/003 pending | Approval, hashing, ownership, share-security tests; renderer pending |
