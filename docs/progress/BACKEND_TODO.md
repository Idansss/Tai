...
- [x] TMS-B2-002 Implement collections, drops, editions, stories, tags, and catalogue search
  ...
  - Notes: Verified locally on `codex/b2-catalogue-content` from merge `daae9f37ea6119fdf8d4cc387fdd701d80a2de6c`; focused PR/CI/merge pending. Migration: `20260716084000_catalogue_content`. API integration files run serially with bounded test/hook timeouts to avoid disposable-PostgreSQL resource contention. Waitlists, preorder/purchase-limit commerce, and drop engagement remain TMS-B7-001/B4; media and garments remain TMS-B2-004/TMS-B2-003.
