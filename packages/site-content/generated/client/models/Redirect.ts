...
> = {
  where?: Prisma.RedirectWhereInput;
  orderBy?:
    Prisma.RedirectOrderByWithAggregationInput | Prisma.RedirectOrderByWithAggregationInput[];
...
export type RedirectWhereInput = {
  ...
  fromPath?: Prisma.StringFilter<'Redirect'> | string;
  toPath?: Prisma.StringFilter<'Redirect'> | string;
...
export type RedirectScalarWhereWithAggregatesInput = {
  AND?:
    Prisma.RedirectScalarWhereWithAggregatesInput | Prisma.RedirectScalarWhereWithAggregatesInput[];
  OR?: Prisma.RedirectScalarWhereWithAggregatesInput[];
  NOT?:
    Prisma.RedirectScalarWhereWithAggregatesInput | Prisma.RedirectScalarWhereWithAggregatesInput[];
  id?: Prisma.UuidWithAggregatesFilter<'Redirect'> | string;
  fromPath?: Prisma.StringWithAggregatesFilter<'Redirect'> | string;
  toPath?: Prisma.StringWithAggregatesFilter<'Redirect'> | string;
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'fromPath' | 'toPath' | 'statusCode' | 'enabled' | 'createdAt' | 'updatedAt',
  ExtArgs['result']['redirect']
>;
...
export type RedirectGetPayload<S extends boolean | null | undefined | RedirectDefaultArgs> =
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, RedirectGroupByArgs, OrderByArg> & InputErrors,
  ): {} extends InputErrors ? GetRedirectGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
  /**
...
export interface RedirectFieldRefs {
  ...
  readonly fromPath: Prisma.FieldRef<'Redirect', 'String'>;
  readonly toPath: Prisma.FieldRef<'Redirect', 'String'>;
